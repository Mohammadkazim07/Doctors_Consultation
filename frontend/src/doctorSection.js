      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center bg-gradient-to-br from-purple-50 to-pink-100 shadow-xl rounded-lg">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-12 md:pl-8 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="mb-8 text-gray-600 leading-relaxed text-sm sm:text-base">
            I embarked on my educational journey at <strong>Jawahar Navodaya Vidyalaya</strong> (JNV) in Araria and graduated in Ayurveda from Government Ayurveda College, Patna. I further pursued my <strong>MD in Medicine</strong> from Aryabhatta Knowledge University. With extensive experience in Ayurvedic medicine, I have contributed to numerous healthcare institutions across Bihar.
          </p>

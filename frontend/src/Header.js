      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="/">
          <img
            ...
            decoding="async"
          />
          <span className="flex items-center sm:text-5xl text-4xl mb-4 font-bold text-gray-400 bg-white border-0 py-2 px-4 w-auto focus:outline-none rounded">
            CHEST & KIDNEY CARE CENTRE
          </span>
        </a>
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <a className="mr-5 hover:text-gray-900 hover:bg-green-200" href="#1">
            Profile
          </a>
